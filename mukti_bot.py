...
def near_location(lon2,lat2,cord):
    threshold_dist=1
    loc=[]
    i=0
    minimum=1e9
...
# print("Hello dear,My name is Mukti,How may I help you?")

def chatbot_main(message):
